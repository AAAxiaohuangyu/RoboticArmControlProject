...
void LK4005_Motor_Control_Init(void)
{
    ...
    LK4005_Motor_Handle[1].Motor_MIT_Control_Handle[0].MIT_Kp = 15.5f;
    LK4005_Motor_Handle[1].Motor_MIT_Control_Handle[1].MIT_Kp = 31.48f;
    LK4005_Motor_Handle[1].Motor_MIT_Control_Handle[0].MIT_Kd = 2.1f;
    LK4005_Motor_Handle[1].Motor_MIT_Control_Handle[1].MIT_Kd = 1.8f;
    LK4005_Motor_Handle[1].Motor_MIT_Control_Handle[0].Motor_Torque_Friction = 0.07f;
    LK4005_Motor_Handle[1].Motor_MIT_Control_Handle[1].Motor_Torque_Friction = 0.07f;
